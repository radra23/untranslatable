...
- `wordCounter` uses the same metric name (`words.requests`) and `language` label as Python — TypeScript and Python share one Prometheus query; .NET exports under `app_requests_words_by_language_total` (a separate metric)
