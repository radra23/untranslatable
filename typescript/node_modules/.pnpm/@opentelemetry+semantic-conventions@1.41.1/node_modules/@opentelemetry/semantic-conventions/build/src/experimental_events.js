...
exports.EVENT_SESSION_START = exports.EVENT_SESSION_END = exports.EVENT_RPC_SERVER_CALL_EXCEPTION = exports.EVENT_RPC_MESSAGE = exports.EVENT_RPC_CLIENT_CALL_EXCEPTION = exports.EVENT_MESSAGING_SETTLE_EXCEPTION = exports.EVENT_MESSAGING_SEND_EXCEPTION = exports.EVENT_MESSAGING_RECEIVE_EXCEPTION = exports.EVENT_MESSAGING_PROCESS_EXCEPTION = exports.EVENT_MESSAGING_CREATE_EXCEPTION = exports.EVENT_HTTP_SERVER_REQUEST_EXCEPTION = exports.EVENT_HTTP_CLIENT_REQUEST_EXCEPTION = exports.EVENT_GEN_AI_USER_MESSAGE = exports.EVENT_GEN_AI_TOOL_MESSAGE = exports.EVENT_GEN_AI_SYSTEM_MESSAGE = exports.EVENT_GEN_AI_EVALUATION_RESULT = exports.EVENT_GEN_AI_CLIENT_OPERATION_EXCEPTION = exports.EVENT_GEN_AI_CLIENT_INFERENCE_OPERATION_DETAILS = exports.EVENT_GEN_AI_CHOICE = exports.EVENT_GEN_AI_ASSISTANT_MESSAGE = exports.EVENT_FEATURE_FLAG_EVALUATION = exports.EVENT_FAAS_INVOCATION_EXCEPTION = exports.EVENT_DEVICE_APP_LIFECYCLE = exports.EVENT_DB_CLIENT_OPERATION_EXCEPTION = exports.EVENT_BROWSER_WEB_VITAL = exports.EVENT_AZURE_RESOURCE_LOG = exports.EVENT_AZ_RESOURCE_LOG = exports.EVENT_APP_WIDGET_CLICK = exports.EVENT_APP_SCREEN_CLICK = exports.EVENT_APP_JANK = void 0;
//-----------------------------------------------------------------------------------------------------------------
 ...
 * @experimental This event is experimental and is subject to breaking changes in minor releases of `@opentelemetry/semantic-conventions`.
 */
exports.EVENT_FAAS_INVOCATION_EXCEPTION = 'faas.invocation.exception';
/**
 ...
 * @experimental This event is experimental and is subject to breaking changes in minor releases of `@opentelemetry/semantic-conventions`.
 */
exports.EVENT_GEN_AI_CLIENT_OPERATION_EXCEPTION = 'gen_ai.client.operation.exception';
/**
 ...
 * @experimental This event is experimental and is subject to breaking changes in minor releases of `@opentelemetry/semantic-conventions`.
 */
exports.EVENT_MESSAGING_CREATE_EXCEPTION = 'messaging.create.exception';
/**
 ...
 * @experimental This event is experimental and is subject to breaking changes in minor releases of `@opentelemetry/semantic-conventions`.
 */
exports.EVENT_MESSAGING_PROCESS_EXCEPTION = 'messaging.process.exception';
/**
 ...
 * @experimental This event is experimental and is subject to breaking changes in minor releases of `@opentelemetry/semantic-conventions`.
 */
exports.EVENT_MESSAGING_RECEIVE_EXCEPTION = 'messaging.receive.exception';
/**
 ...
 * @experimental This event is experimental and is subject to breaking changes in minor releases of `@opentelemetry/semantic-conventions`.
 */
exports.EVENT_MESSAGING_SEND_EXCEPTION = 'messaging.send.exception';
/**
 ...
 * @experimental This event is experimental and is subject to breaking changes in minor releases of `@opentelemetry/semantic-conventions`.
 */
exports.EVENT_MESSAGING_SETTLE_EXCEPTION = 'messaging.settle.exception';
/**
