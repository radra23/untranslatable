...
var OTLPMetricExporter = /** @class */ (function (_super) {
    ...
    function OTLPMetricExporter(config) {
        return _super.call(this, createOtlpHttpExportDelegate(convertLegacyHttpOptions(config !== null && config !== void 0 ? config : {}, 'METRICS', 'v1/metrics', {
            'User-Agent': "OTel-OTLP-Exporter-JavaScript/" + VERSION,
            'Content-Type': 'application/x-protobuf',
        }), ProtobufMetricsSerializer), config) || this;
    }
